...
│   │   ├── data_type-trades/
│   │   │   ├── binance:SPOT_ASSET:BTC-USDT.parquet          # High-frequency execution data
│   │   │   ├── binance:SPOT_ASSET:ETH-USDT.parquet
│   │   │   ├── deribit:Perp:BTC-USDT.parquet
│   │   │   └── deribit:Option:BTC-USD-50000-241225-C.parquet
│   │   ├── data_type-book_snapshot_5/
│   │   │   ├── binance:SPOT_ASSET:BTC-USDT.parquet          # Order book for execution
│   │   │   ├── binance:SPOT_ASSET:ETH-USDT.parquet
│   │   │   └── deribit:Perp:BTC-USDT.parquet
...
if __name__ == "__main__":
    ...
    availability_data = pd.DataFrame({
        'instrument_id': ['binance:SPOT_ASSET:BTC-USDT', 'binance:SPOT_ASSET:ETH-USDT'],
